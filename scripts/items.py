            ...
            if valores == 'data':
                for valor in lista[valores]:
                    ...
                    if(not(champions.__contains__(v))):
                        ...
                        #print('ESTOU AQUI')
                        print(
                            "###  http://www.tartesdajulia.com/ontologies/LeagueOfLegends#" + v)
                        ...
                        if flag == 0:
                            ...
                            for buildf in eval(buildFrom):
                                print(
                                    "                :buildsFrom <http://www.tartesdajulia.com/ontologies/LeagueOfLegends#" + buildf + "> ;")
                            flag = 0
                        for tag in eval(tags):
                            print("                :hasItemTag :" + tag + ";")
                        print(
                            "                :hasItemImage <http://www.tartesdajulia.com/ontologies/LeagueOfLegends#" + v + "Image> ;")
                        print('                :description "' +
                              description + '";')
                        print('                :name "' + name + '";')
                        print("                :id " + v + ' .\n')
